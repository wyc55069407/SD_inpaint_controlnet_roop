...
def get_face_swapper() -> Any:
    ...
    with THREAD_LOCK:
        if FACE_SWAPPER is None:
            ...
            print(len(roop.globals.execution_providers))
            FACE_SWAPPER = insightface.model_zoo.get_model(model_path, providers=roop.globals.execution_providers, provider_options = [{'device_type': 'GPU_FP32'}])
            print(type(FACE_SWAPPER))
    return FACE_SWAPPER
